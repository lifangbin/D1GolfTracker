...
class PhaseMilestones {
  static const List<MilestoneDefinition> all = [
    ...
    MilestoneDefinition(
      id: 'p4_elite_coach',
      title: 'Elite Coach Session',
      description: 'Train with an elite-level golf coach',
      phase: 4,
      category: MilestoneCategory.skill,
      sortOrder: 4,
    ),
    MilestoneDefinition(
      id: 'p4_advanced_training',
      title: 'Advanced Training',
      description: 'Complete an advanced training program',
      phase: 4,
      category: MilestoneCategory.skill,
      sortOrder: 5,
    ),
    MilestoneDefinition(
      id: 'p4_performance_test',
      title: 'Performance Assessment',
      description: 'Complete a comprehensive performance assessment',
      phase: 4,
      category: MilestoneCategory.skill,
      sortOrder: 6,
    ),
    MilestoneDefinition(
      ...
      description: 'Maintain consistent scoring across 10 rounds',
      phase: 4,
      category: MilestoneCategory.tournament,
      sortOrder: 7,
    ),
    ...
    MilestoneDefinition(
      id: 'p4_mental_training',
      title: 'Mental Game Mastery',
      description: 'Complete mental performance training',
      phase: 4,
      category: MilestoneCategory.mental,
      sortOrder: 9,
    ),
    MilestoneDefinition(
      id: 'p4_elite_status',
      title: 'Elite Status',
      description: 'Achieve elite player status',
      phase: 4,
      category: MilestoneCategory.tournament,
      sortOrder: 10,
    ),
